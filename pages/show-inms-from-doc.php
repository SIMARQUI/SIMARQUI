<?php
	...
	$consulta = "select id_inm, descripcion, modo_adq, direccion, metraje, tipo_inm, linderos from inmueble, se_refiere where (id_docf = '$id_doc') And (id_inm = id_inmfff) "; 
	...
	if(mysqli_num_rows($registros) > 0)
	{
		...
		while($fila = mysqli_fetch_array($registros))
		{
			echo	"<div class='panel panel-primary'>
						...
						<span style='font-weight:bold'>Codigo del inmueble:</span> ".$fila['id_inm'];
